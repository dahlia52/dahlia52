...
## 🔎About me
- M.S. in `Data Intelligence (DI) Lab, Graduate School of Artificial Intelligence (GSAI)` in POSTECH `2025.2~` 
- B.S. in `Statistics` and `Computer Science` in Ewha Womans University `2020.3~2025.2`
